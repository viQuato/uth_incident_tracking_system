...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<link rel="stylesheet" href="<?php echo $set->url; ?>/datatables/dataTables.bootstrap.css">
		<link rel="stylesheet" href="<?php echo $set->url; ?>/datatables/jquery.dataTables.min.css">
