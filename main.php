				...
				<form  action= "databaseConnect.php" method="Post">
					<table class="tg" border="1" align="center" width="1200">
						...
						<tr>
					      ...
					      <input type="text" name="documentId" value ="<?php echo uniqid();?>" ></th>
					...
					<td colspan="3" rowspan="3" valign="top">
					  ...
					  <tr>
						...
						<td colspan="3" rowspan="3" valign="top">
							...
							<h4><input type="checkbox" name="complaints[]" value=" Complaint by staff member"> Complaint by staff member<h4>
							<h4><input type="checkbox" name="complaints[]" value=" Complaint by patients relative" > Complaint by patient’s relative </h4>
							<h4><input type="checkbox" name="complaints[]" ><input type="text" placeholder="Other" name="qcOther" id="complaintOther"><h4>
						</td>
						<td colspan="3" rowspan="3" valign="top">
								<h4><input type="checkbox" name="computer[]" value="LIS-related ">LIS-related <br> (Please fill in LIS Issues Form LIS-FM-001)<h4>
