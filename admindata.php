...
<thead>
	<tr bgcolor="#D3D3D3">
		<th width="20%"> <h3>Document ID <h3> </th>
		<th width="20%"> <h3>Reference Number <h3> </th>
		<th width="20%"><h3> Department </h3></th>
		<th width="20%"> <h3>Date Of Incident<h3> </th>
...
<tbody>
	...
	<tr class="record" align = "center">
		...
		<a href="delete.php?id=<?php echo $row['form_id']; ?>" class="delbutton" >delete</a> 
